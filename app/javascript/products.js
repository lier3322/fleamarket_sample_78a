...
$(function(){
  ...
  function appendChildrenBox(insertHTML){
    var childSelectHtml = '';
    childSelectHtml = `<div class='category__styleSelect__selectarea__listen' id= 'children_wrapper'>
  ...
  function appendGrandchildrenBox(insertHTML){
    ...
    grandchildSelectHtml = `<div class='category__styleSelect__selectarea__listen' id= 'grandchildren_wrapper'>
                              <div class='category__styleSelect__selectarea__listen__added'>
                                <select class="lcategory__styleSelect__selectarea__listen__added__box" id="grandchild_category" name="category_id">
                                  <option value="---" data-category="---">---</option>
                                  ${insertHTML}
                                </select>
                              </div>
  ...
  $(document).on('change', '#child_category', function(){
    var parentCategory = document.getElementById('child_category').value;
    if (parentCategory != "---"){
      $.ajax({
